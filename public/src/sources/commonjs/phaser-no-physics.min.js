...
(function() {
    ...
    b.WEBGL_RENDERER = 0, b.CANVAS_RENDERER = 1, b.VERSION = "v2.0.0", b.blendModes = {
            ...
            return c
        }, b.Polygon.prototype.constructor = b.Polygon, b.Matrix = function() {
        ...
        function(a) {
            ...
            this.width = a * this.resolution, this.height = b * this.resolution, this.view.width = this.width, this.view.height = this.height, this.view.style.width = this.width / this.resolution + "px", this.view.style.height = this.height / this.resolution + "px"
        ...
        }, b.RenderTexture.tempMatrix = new b.Matrix, b.AbstractFilter = function(a, b) {
    ...
    function() {
        ...
        window.console || (window.console = {}, window.console.log = window.console.assert = function() {}, window.console.warn = window.console.assert = function() {}), b.Circle = function(a, b, c) {
            ...
            c = c || "x", d = d || "y";
            var e = new b.Point;
            return a[c] && (e.x = parseInt(a[c], 10)), a[d] && (e.y = parseInt(a[d], 10)), e
            ...
            "undefined" == typeof c && (c = new b.Rectangle);
            ...
            if (this.type = b.POLYGON, a instanceof Array || (a = Array.prototype.slice.call(arguments)), a[0] instanceof b.Point) {
                for (var c = [], d = 0, e = a.length; e > d; d++) c.push(a[d].x, a[d].y);
                a = c
            }
            this.points = a, this.closed = !0
        }, b.Polygon.prototype = {
            clone: function(a) {
                var c = this.points.slice();
                return "undefined" == typeof a || null === a ? a = new b.Polygon(c) : a.setTo(c), a
            },
            contains: function(a, b) {
                for (var c = !1, d = this.points.length / 2, e = 0, f = d - 1; d > e; f = e++) {
                    var g = this.points[2 * e].x,
                        h = this.points[2 * e + 1].y,
                        i = this.points[2 * f].x,
                        j = this.points[2 * f + 1].y,
                        k = h > b != j > b && (i - g) * (b - h) / (j - h) + g > a;
                    k && (c = !c)
                }
                return c
            ...
            if (this.lineWidth = a || 0, this.lineColor = b || 0, this.lineAlpha = arguments.length < 3 ? 1 : c, this.currentPath) {
            ...
            if (this.visible !== !1 && 0 !== this.alpha && this.isMask !== !0) {
                if (this._cacheAsBitmap) return (this.dirty || this.cachedSpriteDirty) && (this._generateCachedSprite(), this.updateCachedSpriteTexture(), this.cachedSpriteDirty = !1, this.dirty = !1), this._cachedSprite.alpha = this.alpha, void PIXI.Sprite.prototype._renderWebGL.call(this._cachedSprite, a);
            ...
            if (this.visible !== !1 && 0 !== this.alpha && this.isMask !== !0) {
                if (this._cacheAsBitmap) return (this.dirty || this.cachedSpriteDirty) && (this._generateCachedSprite(), this.updateCachedSpriteTexture(), this.cachedSpriteDirty = !1, this.dirty = !1), this._cachedSprite.alpha = this.alpha, void PIXI.Sprite.prototype._renderCanvas.call(this._cachedSprite, a);
                var b = a.context,
                    c = this.worldTransform;
            ...
            if (this.graphicsData.length)
                for (var e, f, g, h, i, j, k = 0; k < this.graphicsData.length; k++) {
                    var l = this.graphicsData[k],
                        m = l.type,
                        n = l.lineWidth;
                    if (e = l.shape, m === PIXI.Graphics.RECT || m === PIXI.Graphics.RRECT) g = e.x - n / 2, h = e.y - n / 2, i = e.width + n, j = e.height + n, a = a > g ? g : a, b = g + i > b ? g + i : b, c = c > h ? h : c, d = h + j > d ? h + j : d;
                        ...
                        f = e.points;
                        for (var o = 0; o < f.length; o += 2) g = f[o], h = f[o + 1], a = a > g - n ? g - n : a, b = g + n > b ? g + n : b, c = c > h - n ? h - n : c, d = h + n > d ? h + n : d
                    }
                } else a = 0, b = 0, c = 0, d = 0;
            var p = this.boundsPadding,
                q = this._bounds;
            q.x = a - p, q.width = b - a + 2 * p, q.y = c - p, q.height = d - c + 2 * p
            ...
            this.game = a, this.world = a.world, this.id = 0, this.view = new b.Rectangle(d, e, f, g), this.screenView = new b.Rectangle(d, e, f, g), this.bounds = new b.Rectangle(d, e, f, g), this.deadzone = null, this.visible = !0, this.roundPx = !0, this.atLimit = {
                x: !1,
                y: !1
            }, this.target = null, this._edge = 0, this._position = new b.Point, this.displayObject = null, this.scale = null, this._targetPosition = new b.Point
            ...
            boot: function() {
                this.game.onPause.add(this.pause, this), this.game.onResume.add(this.resume, this), this.game.load.onLoadComplete.add(this.loadComplete, this), null !== this._pendingState && "string" != typeof this._pendingState && this.add("default", this._pendingState, !0)
            },
            add: function(a, c, d) {
            ...
            this.game = a, this.type = b.WEBGL_FILTER, this.passes = [this], this.shaders = [], this.dirty = !0, this.padding = 0, this.prevPoint = new b.Point;
            var e = new Date;
            if (this.uniforms = {
                    resolution: {
                        type: "2f",
            ...
            for (var d = -1, e = this.children.length, f = new b.ArrayList; ++d < e;) {
                var g = this.children[d];
                (!c || c && g.exists) && a(g, d, this.children) && f.add(g)
            }
            return f
            ...
            createCustomLayer: function(a, c, d, e) {
                "undefined" == typeof e && (e = !0), this.customWidth = a, this.customHeight = c, this.boundsCustom.width = a, this.boundsCustom.height = c;
            ...
            setUpRenderer: function() {
                if (this.canvas = this.config.canvasID ? b.Canvas.create(this.width, this.height, this.config.canvasID) : b.Canvas.create(this.width, this.height), this.config.canvasStyle ? this.canvas.style = this.config.canvasStyle : this.canvas.style["-webkit-full-screen"] = "width: 100%; height: 100%", this.device.cocoonJS && (this.canvas.screencanvas = this.renderType === b.CANVAS ? !0 : !1), this.renderType === b.HEADLESS || this.renderType === b.CANVAS || this.renderType === b.AUTO && this.device.webGL === !1) {
                    if (!this.device.canvas) throw new Error("Phaser.Game - cannot create Canvas or WebGL context, aborting.");
                    this.renderType === b.AUTO && (this.renderType = b.CANVAS), this.renderer = new PIXI.CanvasRenderer(this.width, this.height, {
                        view: this.canvas,
                        transparent: this.transparent,
                        resolution: 1,
                        clearBeforeRender: !0
                    }), this.context = this.renderer.context
                } else this.renderType = b.WEBGL, this.renderer = new PIXI.WebGLRenderer(this.width, this.height, {
                    view: this.canvas,
                    transparent: this.transparent,
                    resolution: 1,
            ...
            hitTest: function(a, c, d) {
                ...
                if (this.getLocalPosition(a, c, this._localPoint), d.copyFrom(this._localPoint), a.hitArea && a.hitArea.contains) return a.hitArea.contains(this._localPoint.x, this._localPoint.y);
            ...
            "undefined" == typeof d && (d = 256), "undefined" == typeof e && (e = 256), this.game = a, this.key = c, this.width = d, this.height = e, this.canvas = b.Canvas.create(d, e, "", !0), this.context = this.canvas.getContext("2d"), this.ctx = this.context, this.imageData = this.context.getImageData(0, 0, d, e), this.data = this.imageData.data, this.pixels = null, this.imageData.data.buffer ? (this.buffer = this.imageData.data.buffer, this.pixels = new Uint32Array(this.buffer)) : window.ArrayBuffer ? (this.buffer = new ArrayBuffer(this.imageData.data.length), this.pixels = new Uint32Array(this.buffer)) : this.pixels = this.imageData.data, this.baseTexture = new PIXI.BaseTexture(this.canvas), this.texture = new PIXI.Texture(this.baseTexture), this.textureFrame = new b.Frame(0, 0, 0, d, e, "bitmapData", a.rnd.uuid()), this.texture.frame = this.textureFrame, this.type = b.BITMAPDATA, this.disableTextureUpload = !1, this.dirty = !1, this.cls = this.clear, this._image = null, this._pos = new b.Point, this._size = new b.Point, this._scale = new b.Point, this._rotate = 0, this._alpha = {
                prev: 1,
                current: 1
            }, this._anchor = new b.Point, this._tempR = 0, this._tempG = 0, this._tempB = 0, this._circle = new b.Circle
            ...
            getFirstPixel: function(a) {
                ...
                do b.Color.unpackPixel(this.getPixel32(d, e), c), 0 === a || 1 === a ? (d++, d === this.width && (d = 0, e += f, (e >= this.height || 0 >= e) && (g = !0))) : (2 === a || 3 === a) && (e++, e === this.height && (e = 0, d += f, (d >= this.width || 0 >= d) && (g = !0))); while (0 === c.a && !g);
                return c.x = d, c.y = e, c
            },
            getBounds: function(a) {
                return "undefined" == typeof a && (a = new b.Rectangle), a.x = this.getFirstPixel(2).x, a.x === this.width ? a.setTo(0, 0, 0, 0) : (a.y = this.getFirstPixel(0).y, a.width = this.getFirstPixel(3).x - a.x + 1, a.height = this.getFirstPixel(1).y - a.y + 1, a)
            },
            ...
            }, this.texture.width = a.sourceSizeW, this.texture.height = a.sourceSizeH, this.texture.frame.width = a.sourceSizeW, this.texture.frame.height = a.sourceSizeH) : !a.trimmed && this.texture.trim && (this.texture.trim = null), this.cropRect && this.updateCrop(), this.texture._updateUvs()
            ...
            if (this.cropRect) {
                ...
                this.texture.crop.x = a, this.texture.crop.y = c, this.texture.crop.width = d, this.texture.crop.height = e, this.texture.frame.width = Math.min(d, this.cropRect.width), this.texture.frame.height = Math.min(e, this.cropRect.height), this.texture.width = this.texture.frame.width, this.texture.height = this.texture.frame.height, this.texture._updateUvs()
            }
            ...
            this.texture.frame.x = a.x, this.texture.frame.y = a.y, this.texture.frame.width = a.width, this.texture.frame.height = a.height, this.texture.crop.x = a.x, this.texture.crop.y = a.y, this.texture.crop.width = a.width, this.texture.crop.height = a.height, a.trimmed ? (this.texture.trim ? (this.texture.trim.x = a.spriteSourceSizeX, this.texture.trim.y = a.spriteSourceSizeY, this.texture.trim.width = a.sourceSizeW, this.texture.trim.height = a.sourceSizeH) : this.texture.trim = {
                ...
                width: a.sourceSizeW,
                height: a.sourceSizeH
            }, this.texture.width = a.sourceSizeW, this.texture.height = a.sourceSizeH, this.texture.frame.width = a.sourceSizeW, this.texture.frame.height = a.sourceSizeH) : !a.trimmed && this.texture.trim && (this.texture.trim = null), this.texture._updateUvs()
            ...
            var k, l;
            for (this._charCount = 0, f = 0; f < b.length; f++) k = this.style.strokeThickness / 2, l = this.style.strokeThickness / 2 + f * i + e.ascent, "right" === this.style.align ? k += d - c[f] : "center" === this.style.align && (k += (d - c[f]) / 2), l += this._lineSpacing, this.colors.length > 0 ? this.updateLine(b[f], k, l) : (this.style.stroke && this.style.strokeThickness && this.context.strokeText(b[f], k, l), this.style.fill && this.context.fillText(b[f], k, l));
            this.updateTexture()
            ...
            set: function(a) {
                a !== this._font && (this._font = a.trim(), this.style.font = this._fontWeight + " " + this._fontSize + "px '" + this._font + "'", this.dirty = !0, this.parent && this.updateTransform())
            }
            ...
            set: function(a) {
                a = parseInt(a, 10), a !== this._fontSize && (this._fontSize = a, this.style.font = this._fontWeight + " " + this._fontSize + "px '" + this._font + "'", this.dirty = !0, this.parent && this.updateTransform())
            }
            ...
            set: function(a) {
                a !== this._fontWeight && (this._fontWeight = a, this.style.font = this._fontWeight + " " + this._fontSize + "px '" + this._font + "'", this.dirty = !0, this.parent && this.updateTransform())
            }
            ...
            this.onOverSound = null, this.onOverSoundMarker = "", (a instanceof b.Sound || a instanceof b.AudioSprite) && (this.onOverSound = a), "string" == typeof c && (this.onOverSoundMarker = c)
        }, b.Button.prototype.setOutSound = function(a, c) {
            this.onOutSound = null, this.onOutSoundMarker = "", (a instanceof b.Sound || a instanceof b.AudioSprite) && (this.onOutSound = a), "string" == typeof c && (this.onOutSoundMarker = c)
        }, b.Button.prototype.setDownSound = function(a, c) {
            this.onDownSound = null, this.onDownSoundMarker = "", (a instanceof b.Sound || a instanceof b.AudioSprite) && (this.onDownSound = a), "string" == typeof c && (this.onDownSoundMarker = c)
        }, b.Button.prototype.setUpSound = function(a, c) {
            this.onUpSound = null, this.onUpSoundMarker = "", (a instanceof b.Sound || a instanceof b.AudioSprite) && (this.onUpSound = a), "string" == typeof c && (this.onUpSoundMarker = c)
        }, b.Button.prototype.onInputOverHandler = function(a, b) {
            b.justReleased() || (this.freezeFrames === !1 && this.setState(1), (!this.onOverMouseOnly || b.isMouse) && (this.onOverSound && this.onOverSound.play(this.onOverSoundMarker), this.onInputOver && this.onInputOver.dispatch(this, b)))
            ...
            "undefined" == typeof e && (e = ""), "undefined" == typeof f && (f = b.scaleModes.DEFAULT), "undefined" == typeof g && (g = 1), this.game = a, this.key = e, this.type = b.RENDERTEXTURE, this.matrix = new PIXI.Matrix, PIXI.RenderTexture.call(this, c, d, this.game.renderer, f, g), this.render = b.RenderTexture.prototype.render
            ...
            canPlayAudio: function(a) {
				return true;
              //  return "mp3".. / Wca396c523482d.htm "ogg" == a && (this.ogg || this.opus) ? !0 : "m4a" == a && this.m4a ? !0 : "opus" == a && this.opus ? !0 : "wav".. / Wcece35e148daa.htm "webm" == a && this.webm ? !0 : !1
            },
            ...
            update: function(a) {
                if (this.prevTime = this.now, this.now = a, this.timeToCall = this.game.math.max(0, 16 - (a - this.lastTime)), this.elapsed = this.now - this.time, this.elapsed > this.timeCap && (this.elapsed = this.timeCap), this.physicsElapsed = this.elapsed / 1e3 || 1 / 60, this.deltaCap > 0 && this.physicsElapsed > this.deltaCap && (this.physicsElapsed = this.deltaCap), this.advancedTiming && (this.msMin = this.game.math.min(this.msMin, this.elapsed), this.msMax = this.game.math.max(this.msMax, this.elapsed), this.frames++, this.now > this._timeLastSecond + 1e3 && (this.fps = Math.round(1e3 * this.frames / (this.now - this._timeLastSecond)), this.fpsMin = this.game.math.min(this.fpsMin, this.fps), this.fpsMax = this.game.math.max(this.fpsMax, this.fps), this._timeLastSecond = this.now, this.frames = 0)), this.time = this.now, this.lastTime = a + this.timeToCall, !this.game.paused)
            ...
            addBitmapData: function(a, b, c) {
                return b.key = a, this._bitmapDatas[a] = {
                    data: b,
                    frameData: c
                }, b
            },
            ...
            addSpriteSheet: function(a, c, d, e, f, g, h, i) {
                this._images[a] = {
                    ...
                    margin: h,
                    spacing: i
                }, PIXI.BaseTextureCache[a] = new PIXI.BaseTexture(d), PIXI.TextureCache[a] = new PIXI.Texture(PIXI.BaseTextureCache[a]), this._images[a].frameData = b.AnimationParser.spriteSheet(this.game, a, e, f, g, h, i), this._urlMap[this._resolveUrl(c)] = this._images[a]
            },
            addTilemap: function(a, b, c, d) {
                this._tilemaps[a] = {
                    ...
                    data: c,
                    format: d
                }, this._urlMap[this._resolveUrl(b)] = this._tilemaps[a]
            },
            addTextureAtlas: function(a, c, d, e, f) {
                this._images[a] = {
                    url: c,
                    data: d
                }, PIXI.BaseTextureCache[a] = new PIXI.BaseTexture(d), PIXI.TextureCache[a] = new PIXI.Texture(PIXI.BaseTextureCache[a]), f == b.Loader.TEXTURE_ATLAS_JSON_ARRAY ? this._images[a].frameData = b.AnimationParser.JSONData(this.game, e, a) : f == b.Loader.TEXTURE_ATLAS_JSON_HASH ? this._images[a].frameData = b.AnimationParser.JSONDataHash(this.game, e, a) : f == b.Loader.TEXTURE_ATLAS_XML_STARLING && (this._images[a].frameData = b.AnimationParser.XMLData(this.game, e, a)), this._urlMap[this._resolveUrl(c)] = this._images[a]
            },
            addBitmapFont: function(a, c, d, e, f, g) {
                this._images[a] = {
                    url: c,
                    data: d
                }, PIXI.BaseTextureCache[a] = new PIXI.BaseTexture(d), PIXI.TextureCache[a] = new PIXI.Texture(PIXI.BaseTextureCache[a]), b.LoaderParser.bitmapFont(this.game, e, a, f, g), this._bitmapFont[a] = PIXI.BitmapText.fonts[a], this._urlMap[this._resolveUrl(c)] = this._bitmapFont[a]
            },
            addPhysicsData: function(a, b, c, d) {
                this._physics[a] = {
                    ...
                    data: c,
                    format: d
                }, this._urlMap[this._resolveUrl(b)] = this._physics[a]
            },
            ...
            addText: function(a, b, c) {
                this._text[a] = {
                    url: b,
                    data: c
                }, this._urlMap[this._resolveUrl(b)] = this._text[a]
            },
            addJSON: function(a, b, c) {
                this._json[a] = {
                    url: b,
                    data: c
                }, this._urlMap[this._resolveUrl(b)] = this._json[a]
            },
            ...
            addSound: function(a, b, c, d, e) {
                ...
                }, this._urlMap[this._resolveUrl(b)] = this._sounds[a]
            },
            ...
            getBitmapData: function(a) {
                return this._bitmapDatas[a] ? this._bitmapDatas[a].data : void console.warn('Phaser.Cache.getBitmapData: Invalid key: "' + a + '"')
            },
            ...
            getFrameData: function(a, c) {
                return "undefined" == typeof c && (c = b.Cache.IMAGE), this._cacheMap[c][a] ? this._cacheMap[c][a].frameData : null
            },
            ...
            getXML: function(a) {
                return this._xml[a] ? this._xml[a].data : void console.warn('Phaser.Cache.getXML: Invalid key: "' + a + '"')
            },
            getBinary: function(a) {
                return this._binary[a] ? this._binary[a] : void console.warn('Phaser.Cache.getBinary: Invalid key: "' + a + '"')
            },
            getUrl: function(a) {
                return this._urlMap[this._resolveUrl(a)] ? this._urlMap[this._resolveUrl(a)] : void console.warn('Phaser.Cache.getUrl: Invalid url: "' + a + '"')
            },
            getKeys: function(a) {
                var c = null;
                switch (a) {
            ...
            _resolveUrl: function(a) {
                return this._urlResolver.src = this.game.load.baseURL + a, this._urlTemp = this._urlResolver.src, this._urlResolver.src = "", this._urlTemp
            },
            destroy: function() {
                ...
                for (var a in this._xml) delete this._xml[a];
            ...
            xml: function(a, b, c) {
                return "undefined" == typeof c && (c = !1), c ? this.replaceInFileList("xml", a, b) : this.addToFileList("xml", a, b), this
            },
            ...
            audiosprite: function(a, b, c) {
                return this.audio(a, b), this.json(a + "-audioatlas", c), this
            },
                ...
                if (e[d.key])
                    for (var f, g = 0; g < e[d.key].length; g++) switch (f = e[d.key][g], f.type) {
                        ...
                        case "json":
                            ...
                            break;
                        case "xml":
                            this.xml(f.key, f.url, f.overwrite);
                            break;
                        case "script":
            ...
            loadFile: function() {
                ...
                var a = this._fileList[this._fileIndex],
                    c = this;
                switch (this.onFileStart.dispatch(this.progress, a.key, a.url), a.type) {
                    case "image":
                    case "spritesheet":
                    case "textureatlas":
                    case "bitmapfont":
                    ...
                    case "audio":
                        a.url = this.getAudioURL(a.url), null !== a.url ? this.game.sound.usingWebAudio ? this.xhrLoad(this._fileIndex, this.baseURL + a.url, "arraybuffer", "fileComplete", "fileError") : this.game.sound.usingAudioTag && (this.game.sound.touchLocked ? (a.data = new Audio, a.data.name = a.key, a.data.preload = "auto", a.data.src = this.baseURL + a.url, this.fileComplete(this._fileIndex)) : (a.data = new Audio, a.data.name = a.key, a.data.onerror = function() {
                            return c.fileError(c._fileIndex)
                        }, a.data.preload = "auto", a.data.src = this.baseURL + a.url, a.data.addEventListener("canplaythrough", function() {
                            b.GAMES[c.game.id].load.fileComplete(c._fileIndex)
                        }, !1), a.data.load())) : this.fileError(this._fileIndex);
                        break;
                    case "json":
                        ...
                        break;
                    case "xml":
                        this.xhrLoad(this._fileIndex, this.baseURL + a.url, "text", "xmlLoadComplete", "dataLoadError");
                        break;
                    case "tilemap":
            ...
            getAudioURL: function(a) {
                ...
                "string" == typeof a && (a = [a]);
                for (var c = 0; c < a.length; c++)
                    if (b = a[c].toLowerCase(), b = b.substr((Math.max(0, b.lastIndexOf(".")) || 1 / 0) + 1), b.indexOf("?") >= 0 && (b = b.substr(0, b.indexOf("?"))), this.game.device.canPlayAudio(b)) return a[c];
                return null
            },
            ...
            xmlLoadComplete: function(a) {
                "" !== this._xhr.responseType && "text" !== this._xhr.responseType && (console.warn("Invalid XML Response Type", this._fileList[a]), console.warn(this._xhr));
            ...
            for (var c in this.config.spritemap) {
                ...
                d.loop ? e.addMarker(c, d.start, d.end - d.start, null, !0) : e.addMarker(c, d.start, d.end - d.start, null, !1), this.sounds[c] = e
            }
        ...
        }, b.AudioSprite.prototype.constructor = b.AudioSprite, b.Sound = function(a, c, d, e, f) {
            ...
            play: function(a, b, c, d, e) {
                if ("undefined" == typeof a && (a = ""), "undefined" == typeof e && (e = !0), this.isPlaying && !this.allowMultiple && !e && !this.override) return this;
                if (this.isPlaying && !this.allowMultiple && (this.override || e) && (this.usingWebAudio ? "undefined" == typeof this._sound.stop ? this._sound.noteOff(0) : this._sound.stop(0) : this.usingAudioTag && (this._sound.pause(), this._sound.currentTime = 0)), this.currentMarker = a, "" !== a) {
            ...
            fadeIn: function(a, b) {
                "undefined" == typeof b && (b = !1), this.paused || (this.play("", 0, 0, b), this.fadeTo(a, 1))
            },
            fadeOut: function(a) {
                this.fadeTo(a, 0)
            },
            fadeTo: function(a, c) {
                if (this.isPlaying && !this.paused && c !== this.volume) {
                    if ("undefined" == typeof a && (a = 1e3), "undefined" == typeof c) return void console.warn("Phaser.Sound.fadeTo: No Volume Specified.");
                    var d = this.game.add.tween(this).to({
                        volume: c
                    }, a, b.Easing.Linear.None, !0);
                    d.onComplete.add(this.fadeComplete, this)
                }
            },
            ...
            addSprite: function(a) {
                var c = new b.AudioSprite(this.game, a);
                return c
            },
            remove: function(a) {
            ...
            body: function(a, c, d) {
                a.body && (this.start(), a.body.type === b.Physics.ARCADE ? b.Physics.Arcade.Body.render(this.context, a.body, c, d) : a.body.type === b.Physics.NINJA ? b.Physics.Ninja.Body.render(this.context, a.body, c, d) : a.body.type === b.Physics.BOX2D && b.Physics.Box2D.renderBody(this.context, a.body, c), this.stop())
            },
            bodyInfo: function(a, c, d, e) {
                a.body && (this.start(c, d, e, 210), a.body.type === b.Physics.ARCADE ? b.Physics.Arcade.Body.renderBodyInfo(this, a.body) : a.body.type === b.Physics.BOX2D && this.game.physics.box2d.renderBodyInfo(this, a.body), this.stop())
            },
            box2dWorld: function() {
            ...
            box2dBody: function(a, c) {
                this.start(), b.Physics.Box2D.renderBody(this.context, a, c), this.stop()
            }
            ...
            createColor: function(a, c, d, e, f, g, h, i) {
                ...
                return j.color = b.Color.getColor(j.r, j.g, j.b), j.color32 = b.Color.getColor32(j.a, j.r, j.g, j.b), b.Color.updateColor(j)
            },
            ...
            hexToColor: function(a, c) {
                ...
                if (d) {
                    var e = parseInt(d[1], 16),
                        f = parseInt(d[2], 16),
                        g = parseInt(d[3], 16);
                    c ? (c.r = e, c.g = f, c.b = g) : c = b.Color.createColor(e, f, g)
                }
                return c
            },
            webToColor: function(a, c) {
                c || (c = b.Color.createColor());
                var d = /^rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*(\d+(?:\.\d+)?))?\)$/.exec(a);
                return d && (c.r = parseInt(d[1], 10), c.g = parseInt(d[2], 10), c.b = parseInt(d[3], 10)), c
            },
        ...
        }, b.Physics.ARCADE = 0, b.Physics.P2JS = 1, b.Physics.NINJA = 2, b.Physics.BOX2D = 3, b.Physics.CHIPMUNK = 4, b.Physics.prototype = {
            ...
            startSystem: function(a) {
                ...
                else if (a === b.Physics.BOX2D && null === this.box2d) this.box2d = new b.Physics.Box2D(this.game, this.config);
                else if (a === b.Physics.CHIPMUNK && null === this.chipmunk) throw new Error("The Chipmunk physics system has not been implemented yet.")
            },
            enable: function(a, c, d) {
                "undefined" == typeof c && (c = b.Physics.ARCADE), "undefined" == typeof d && (d = !1), c === b.Physics.ARCADE ? this.arcade.enable(a) : c === b.Physics.P2JS && this.p2 ? this.p2.enable(a, d) : c === b.Physics.NINJA && this.ninja ? this.ninja.enableAABB(a) : c === b.Physics.BOX2D && this.box2d && this.box2d.enable(a)
            },
            preUpdate: function() {
        ...
        }, b.Physics.prototype.constructor = b.Physics, b.Particles = function(a) {
        ...
        }, b.Particles.prototype.constructor = b.Particles, "undefined" != typeof exports ? ("undefined" != typeof module && module.exports && (exports = module.exports = b), exports.Phaser = b) : "undefined" != typeof define && define.amd ? define("Phaser", function() {
            return a.Phaser = b
        }()) : a.Phaser = b
    }.call(this);