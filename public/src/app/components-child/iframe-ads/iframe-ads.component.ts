...
// }
  ...
  requestAds(){
    ...
    let url_ads = "https://googleads.g.doubleclick.net/pagead/ads?ad_type=video_image_flash&client=ca-games-pub-8167045239596974&description_url="+href_ads+"&channel="+this.channelID+"&videoad_start_delay=0&hl=en&max_ad_duration=30000";
