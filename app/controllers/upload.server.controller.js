...
exports.captureResult = function(req,res){
    ...
    if(req.body.image){
        ...
        domHTML +=
            ...
            '<div style="font-family:sans-serif;position:absolute;bottom:0;padding: 20px;left:0;width: 100%;color: #fff;text-transform: uppercase;font-size: 5em;font-weight: bold;text-align: center;">'+
            req.body.score +
            '</div></div>';
    } else {
        var domHTML = '<div style="position: absolute;top: 0;left: 0">';
